...
public class LocalTimeDemo {
	public static void main(String[] args) {
		...
		System.out.println("Hour: " + hour + " Minute: " + minute + " Second: " + second); // The time being returned
																							// here is according to the
																							// region/locale/zone in
		...
		System.out.println("Date and Time: " + dateTime); // The time being returned here is according to the
															// region/locale/zone in which the application is hosted.
